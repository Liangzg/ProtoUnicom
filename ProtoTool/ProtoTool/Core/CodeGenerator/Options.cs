...
//        [Option("no-generate-imported", Required = false, HelpText = "Don't generate code from imported .proto files.")]
        ...
        public static Options Parse(IEnumerable<string> inputProto , string outputPath)
        {
            Options options = new Options();
            options.InputProto = inputProto;
            ...
            firstPathCs = Path.Combine(Path.GetDirectoryName(firstPathCs),
